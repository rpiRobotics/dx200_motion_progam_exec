import socket, time
###forked from https://github.com/PTriebold/MotomanConnector
#######################
...
class MotomanConnector:
    def __init__(self,IP = "192.168.55.1", PORT=80, S_pulse = 1341.4, L_pulse = 1341.4, U_pulse = 1341.4, R_pulse = 1000, B_pulse = 1000, T_pulse = 622):
