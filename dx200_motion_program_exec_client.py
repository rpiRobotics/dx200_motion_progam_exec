...
class MotionProgramExecClient:
    def __init__(self, ip='192.168.55.1'):
        self.ip=ip
        self.mh=MotomanConnector(IP="192.168.55.1", PORT=80, S_pulse = 1341.4, L_pulse = 1341.4, U_pulse = 1341.4, R_pulse = 1000, B_pulse = 1000, T_pulse = 622)
    ...
    def execute_motion_program(self, filename):
        ...
        self.robodk_rob.ProgSendRobot('192.168.55.1','JOB',"ftp","")
        ###TODO: add mh execution
...
def main():
    ...
    client.robodk_rob.setFrame(p(0,0,0,0,0,0),-1,r"""Motoman MA2010 Base""")
    client.robodk_rob.MoveJ(p(1232,0,860,0,0,-180),[0,0,0,0,0,0],[0,0,0])
    client.robodk_rob.MoveJ(p(1232,0,593.478,0,0,-180),[0,-1.23097,-15.1604,0,13.9294,0],[0,0,0])
    client.robodk_rob.MoveJ(p(903.741,0,593.478,0,0,-180),[0,-27.1205,-36.7057,0,9.58517,0],[0,0,0])
